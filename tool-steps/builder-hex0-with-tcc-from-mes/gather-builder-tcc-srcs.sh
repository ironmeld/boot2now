...
(
cd ../builder-hex0-with-mes-from-stage0-posix || exit 1
...
echo "src $(wc -c builder-tools/build-builder-tcc-srcs.kaem)"
cat builder-tools/build-builder-tcc-srcs.kaem

echo "src $(wc -c builder-tools/build-builder-tcc-cmds.kaem)"
cat builder-tools/build-builder-tcc-cmds.kaem
